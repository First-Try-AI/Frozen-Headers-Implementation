# ArT Reader - Mobile Version

**Last Updated:** November 2025

## Overview
ArT Reader (Attention, Retention & Timing) is an advanced screen reading platform that transforms text into synchronized audio narration with real-time word highlighting. This is the **mobile-optimized version** with responsive design for smaller screens.
...
- **`styles-dev-panel-specific.css`** - Mobile-specific dev panel styles
...
- **Mobile-responsive design** with overlay interface

## Configuration
- **API Endpoint**: Cloud Run - `https://fta-synth-pyh6ygakfa-uc.a.run.app`
- **Deployment**: https://artreader.art/mobile/
