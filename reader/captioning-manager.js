...
class CaptioningManager {
    ...
    getCurrentPageWords() {
        return this.activeCaptioningSystem ? this.activeCaptioningSystem.getCurrentPageWords() : [];
    }

    findWordAtTime(targetTime, words) {
        return this.activeCaptioningSystem ? this.activeCaptioningSystem.findWordAtTime(targetTime, words) : null;
    }
