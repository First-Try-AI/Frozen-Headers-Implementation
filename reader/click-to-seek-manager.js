...
class ClickToSeekManager {
    ...
    addClickHandler(wordSpan, wordData, audioSystem) {
        wordSpan.addEventListener('click', () => {
            ...
            // When the user presses play again, transition to the correct page
            const playButton = document.getElementById('playButton');
            const playButtonClickHandler = () => {
                const pageIndex = audioSystem.input.dataDisplay.getCurrentPageForTime(startTime);
                audioSystem.input.dataDisplay.updateTextDisplayForPage(pageIndex);
