...
const { generatePagesFromBreaks, eliminatePageGaps } = require('./page-generator');
...
function createPageBreaks(wordTimestamps, thresholds = {}) {
  ...
  // Eliminate gaps between consecutive pages
  debugLog('PAGINATION-CORE', 'Calling page-generator to eliminate gaps');
  ...
  console.log(`🔗 [CONJUNCTION] Pages after conjunction split: ${pagesWithConjunctions.length} (was ${adjustedPages.length})`);
