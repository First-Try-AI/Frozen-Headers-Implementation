...
struct StandardFrozenHeader<BottomContent: View, HeaderOverlay: View>: View {
    ...
    let headerState: AppHeaderView.HeaderState
    let bottomContent: BottomContent
    let headerOverlay: HeaderOverlay

    init(
        state: AppHeaderView.HeaderState,
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            AppHeaderView(state: headerState)
                ...
                .border(Self.showDebugOverlays ? Color.red : Color.clear, width: Self.showDebugOverlays ? 1 : 0)
            ...
            bottomContent
                ...
                .border(Self.showDebugOverlays ? Color.blue : Color.clear, width: Self.showDebugOverlays ? 1 : 0)
        }
        .background(
            // Debug background for the whole header container
            Self.showDebugOverlays ? Color.green.opacity(0.1) : Color.clear
        )
