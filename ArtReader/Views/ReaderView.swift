...
struct ReaderView: View {
    ...
    var body: some View {
        ...
        FrozenPanelView {
            ...
            VStack(spacing: 0) {
                ...
                ZStack {
                    if let response = sessionManager.currentResponse {
                        ...
                        // CHANGED: Removed manual padding adjustments.
                        // Top spacing (15) is handled inside ProgressHeaderView.
                        // Bottom spacing (0) is implicit (end of header).
                        .transition(.opacity)
                    } else {
            ...
            // VISUAL FIX: Add material background to create true "Frozen" effect (occluding content)
            // matching InputView and LoadingView
