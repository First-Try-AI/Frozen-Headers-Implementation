            ...
            <div class="dev-panel-content">
                ...
                <div class="controls-section">
                    ...
                    <div class="control-group">
                        ...
                        <div class="control-wrapper no-checkbox">
                              <input type="range" id="activeFontSizeSlider" class="controls-slider" min="6" max="150" value="36" step="1">
                              <input type="number" id="activeFontSizeInput" class="controls-number-input" value="36" min="6" max="150" step="1">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Inactive</label>
                        <div class="control-wrapper no-checkbox">
                            <input type="range" id="inactiveFontSizeSlider" class="controls-slider" min="6" max="150" value="18" step="1">
                            <input type="number" id="inactiveFontSizeInput" class="controls-number-input" value="18" min="6" max="150" step="1">
                        </div>
                    </div>
                </div>
